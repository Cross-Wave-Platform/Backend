...
def merger(file_names: List[str], used_columns: List[str], merge_type: str, file_type: str) -> None:

    dataframes = []
    metas = []

    for i in file_names:
        temp_df, temp_meta = pyreadstat.read_sav(i, usecols=used_columns)# 
...
if __name__ == "__main__":
    ...
    print(file_names)
    used_columns = ['baby_id', 'pfa0101', 'pfa0102']

    merger(file_names,used_columns,'inner','csv')
